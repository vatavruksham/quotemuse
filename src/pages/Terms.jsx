...
export default function Terms() {
  useDocumentTitle('Terms of Service', 'QuoteMuse terms of service — usage guidelines and service agreement.');
          ...
          <div className="glass-card rounded-xl p-8 space-y-6">
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                By accessing or using QuoteMuse, you agree to be bound by these Terms of Service.
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                QuoteMuse provides AI-powered quote generation and branded card design tools. We
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                All quotes and cards generated through QuoteMuse are your property. You retain full
                commercial rights to use, modify, and distribute generated content. We do not
                claim ownership of your quotes or designs.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                You agree not to use QuoteMuse to generate content that is illegal, harmful,
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                QuoteMuse is provided "as is" without warranties of any kind. We are not liable
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                For questions about these terms, contact us at support@quotemuse.art.
              </p>
            </section>
          </div>
        </AnimateOnScroll>
