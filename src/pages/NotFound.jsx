        ...
        <AnimateOnScroll>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 border border-primary/20 text-ink-soft font-medium px-6 py-3 rounded-lg hover:bg-surface-100 transition-colors"
            >
