...
export default function Login() {
  ...
  useDocumentTitle(isLogin ? 'Login' : 'Register', 'Access your QuoteMuse account or create a new one.');
      ...
      <div className="max-w-md mx-auto px-4">
        <AnimateOnScroll>
          <div className="glass-card rounded-2xl p-8">
            <div className="flex mb-8 bg-surface-100 rounded-lg p-1 border border-primary/10">
              <button
            ...
            <p className="text-sm text-ink-soft text-center mb-6">
              {isLogin
                ? 'Sign in to access your QuoteMuse dashboard.'
                : 'Start writing inspirational quotes with AI today.'}
            </p>
