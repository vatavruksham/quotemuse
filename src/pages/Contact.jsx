...
export default function Contact() {
  useDocumentTitle('Contact', 'Get in touch with the QuoteMuse team for support, partnerships, or general inquiries.');
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimateOnScroll delay={100}>
          <div className="glass-card rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-8 p-4 rounded-lg bg-surface-100">
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-2.5 bg-white border rounded-lg text-ink placeholder-ink-muted transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus:border-transparent resize-none ${
                    errors.message
                      ...
                      : 'border-surface-300 hover:border-primary/30'
                  }`}
                />
                {errors.message && (
