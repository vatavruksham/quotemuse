      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll>
          <SectionHeading
            ...
            title="Trusted by Creators and Brands Worldwide"
            subtitle="See why creators and social media managers use AI to keep quote content flowing."
          />
        </AnimateOnScroll>
        ...
        <AnimateOnScroll delay={100}>
          <div className="max-w-3xl mx-auto relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <button
                onClick={prev}
                className="w-10 h-10 rounded-full bg-white border border-primary/10 flex items-center justify-center text-ink hover:text-primary hover:border-primary/30 transition-colors shadow-sm"
